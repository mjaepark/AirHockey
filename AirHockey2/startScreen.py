...
def air_hockey_start(screen, clock, scr_width, scr_height, mute):
    ...
    while True:
        ...
        disp_text(screen, "AIRHANKEY", (scr_width / 2, 100), celeb_text, colors[color_x][color_y])
        ...
        if abs(mouse[0] - 200) < buttonRadius and abs(mouse[1] - 470) < buttonRadius:
            button_circle(screen, colors[0][0], (200, 470), "Normal", large_text, (255, 255, 255),
            ...
            button_circle(screen, colors[0][0], (200, 470), "Normal", small_text, (255, 255, 255),
                          (scr_width / 2 - 400, scr_height / 2 + 170))

        # difficulty button 'Hard'
        if abs(mouse[0] - 600) < buttonRadius and abs(mouse[1] - 470) < buttonRadius:
            button_circle(screen, colors[4][1], (600, 470), "Crazy", large_text, (255, 255, 255),
            ...
            button_circle(screen, colors[4][1], (600, 470), "Crazy", small_text, (255, 255, 255),
                          (scr_width / 2, scr_height / 2 + 170))
